...
public class Attendance_Database {
    ...
    // public int exitStatus = 0;
    public Attendance_Database(String name) {
        Manage_Courses mc = new Manage_Courses();
        Course = mc.toCheckMyCourse(name);
        this.name = name;
        System.out.println("Selection Menu");
        System.out.println("1\t Add Student Attendance Report");
        // System.out.println("2\t View all quizzes");
        System.out.println("2\t Update Student Attendance Report");
        System.out.println("3\t Delete Student Attendance Report");
        System.out.println("4\t View All Student Attendance Report");
   ...
   boolean findAcadCourseStudent(String rollNumber, String subject){
     ...
     public void add() {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(file, true))) {
            ...
            if(studentCourse.contains(subject) && findAcadCourseStudent(rollNo, subject)){
                ...
                System.out.println("Attendance Report is Already set in the course "+subject+" for "+rollNo+". Please select another one.");
    ...
    public void update(String rollNoToUpdate, String courseName) {
        ...
        try {
            ...
            // } else {
                File temp = new File("AttendanceDataTemp.txt");
                ...
                //     }
                    ...
                    System.out.print("Enter new attendance percentange: ");
                    String newper = sc.nextLine();
                    Scanner sc = new Scanner(file);
                    while (sc.hasNext()){
                        String sent = sc.nextLine();
                        String data[] = sent.split(",");
                        if(data[0].equalsIgnoreCase(rollNoToUpdate) && data[1].equalsIgnoreCase(courseName)){
                            sent = rollNoToUpdate + "," + courseName + "," + newper;
                        }
                        bw.write(sent);
                        bw.newLine();
                    }
    ...
    private void delete(){
        System.out.print("Enter the Roll Number whos attendance you want to delete: ");
        ...
        try{
            ...
            System.out.println("The Following are the Courses whos attendance can be Deleted");
    ...
    //     while(true)new Attendance_Database("Ajay Patel");
    // }
}